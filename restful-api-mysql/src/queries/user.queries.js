...
exports.GET_ME_BY_USER_ID = `SELECT user_id, username, email FROM users WHERE user_id = ?`; // dont return password

exports.GET_ME_BY_USERNAME = `SELECT user_id, username, email FROM users WHERE username = ?`; // dont return password
